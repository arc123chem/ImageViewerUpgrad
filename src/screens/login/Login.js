...
class Login extends Component {
    ...
    loginClickHandler = () => {
        ...
        if (this.state.username === "upgrad" && this.state.password === "upgrad@123") {
            sessionStorage.setItem('username','archana');
            sessionStorage.setItem('access-token', 'IGQVJWYTE5eUFaRTZAaQ1NQOXpfcmZA5SDZASWDg0blh2ZAW5HQXM3ZAzlDQTRjMFB4cXZASRDU3VHdOZAVYtYjdkY1l4VDhSbklidlRDdkh3YmlPTFUtSGpaVmloMzRBU1c0YktiUnF5bW9ESXRWNm9Ha0pLZAwZDZD');
